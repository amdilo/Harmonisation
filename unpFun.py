...
- functions evaluation Earth radiance uncertainty via GUM law of propagation 
    - radiance uncertainty from harmonisation coefficients uncertainty,
    - radiance uncertainty from measurements (data) uncertainty, 
    - (?) radiance uncertainty from uncertainty in adjustment model/data. 
This version works for avhrr series only via class avhrr attributes and methods. 
Later analogous classes will be added for HIRS and microwave series."""
...
- Earth radiance from AVHRR measurement equation
- sensitivity coefficients of the measurement equation 
- Earth radiance unceratinty from  harmonisation (/calibration) coefficients, 
    measurement data/variables and adjustment data/model. """
class avhrr(object):
    ...
    def __init__(self, folder, nclist, notime=False):
        ...
        self.splist = nclist # nc files of sensor pairs matchups
        ...
        # index matrix with sensor pairs and number of matchups
        self.im = None # to fill after reading netCDF files
        
        # size of moving average window for calibration counts
        self.mawsize = None # to fill after reading netCDF files
    ...
    # set moving average window size for sensors in the series
    def setMAWsz(self, mawSz): 
        self.mawsize = mawSz 
        return self.mawsize    
    ...
    ''' Evaluate Earth radiance uncertainty via GUM law of propagation from: 
    coefficients uncertainty and data uncertainty (duplication?).
